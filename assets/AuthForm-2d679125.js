...
`,xe=h.p`
  ...
  letter-spacing: 0.04em;
  color: red;
`,_e=T().shape({email:b().max(63,"Must be between 6 and 63 characters.").min(6,"Must be between 6 and 63 characters.").email("Invalid email address").matches(/[a-zA-Z]([-.\s]?[0-9a-zA-Z_-]){1,}@/,"The @ symbol must be preceded by at least 2 characters").required("Email is required").test("is-valid",e=>`${e.path} is invalid`,e=>e?pe(e):new ie("Invalid value")),password:b().min(7,"Must be between 7 and 32 characters.").max(32,"Must be between 7 and 32 characters.").matches(/^([-.\s]?[a-zA-Zа-яёА-ЯЁ0-9]*)*$/,"Must include numbers and/or letters (uppercase and lowercase) except for whitespace.").required("Password is required"),confirmPassword:b().oneOf([oe("password"),null],"Passwords must match")}),ve=T().shape({name:b().required("Name is required"),city:b().required("City, region are required"),mobile:b().length(13,"For example +380##########. Must be 13 characters.").required("Mobile phone is required")}),be={email:"",password:"",name:"",city:"",mobile:""},y=({name:e})=>d(le,{name:e,render:a=>d(xe,{children:a})}),De=()=>{const[e,a]=U.useState(be),[n,m]=U.useState(0),i=j(),s=u=>{const{email:o,password:f,name:D,city:R,mobile:M}=u;i(ae({email:o,password:f,name:D,city:R,mobile:M}))},r=(u,o=!1)=>{if(a(f=>({...f,...u})),o){s(u);return}m(f=>f+1)};return C(ee,{children:[[d(we,{next:r,data:e}),d(ye,{next:r,prev:u=>{a(o=>({...o,...u})),m(o=>o-1)},data:e})][n],d(te,{position:"bottom-right",autoClose:5e3,hideProgressBar:!1,newestOnTop:!1,closeOnClick:!0,rtl:!1,pauseOnFocusLoss:!0,draggable:!0,pauseOnHover:!0,theme:"colored"})]})},we=e=>{const a=n=>{e.next(n)};return d(V,{initialValues:e.data,validationSchema:_e,onSubmit:a,children:({values:n})=>C(W,{children:[d(w,{placeholder:"Email",type:"email",name:"email",value:n.email||""}),d(y,{name:"email"}),d(w,{placeholder:"Password",type:"password",name:"password",value:n.password||""}),d(y,{name:"password"}),d(w,{placeholder:"Confirm Password",type:"password",name:"confirmPassword",value:n.confirmPassword||""}),d(y,{name:"confirmPassword"}),d(Q,{type:"submit",children:"Next"})]})})},ye=e=>{const a=(n,m)=>{e.next(n,!0)};return d(V,{initialValues:e.data,validationSchema:ve,onSubmit:a,children:({values:n})=>C(W,{children:[d(w,{placeholder:"Name",type:"text",name:"name",value:n.name||""}),d(y,{name:"name"}),d(w,{placeholder:"City, region",type:"text",name:"city",value:n.city||""}),d(y,{name:"city"}),d(w,{placeholder:"Mobile phone",type:"text",name:"mobile",value:n.mobile||""}),d(y,{name:"mobile"}),d(Q,{type:"submit",children:"Register"}),d(he,{type:"button",onClick:()=>e.prev(n),children:"Back"})]})})};export{De as A,y as F,Se as R,Pe as a,Ee as b,ke as c,qe as d,pe as i,ge as l};
