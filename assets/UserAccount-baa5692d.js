import{s as p,u as J,r as m,a,j as f,e as Wt,f as Ut,d as H,A as bt,F as q,k as Me,Q as M,h as Ht,p as h,i as qt,l as Kt,m as Nt,n as Vt,o as Zt}from"./index-244ce7b5.js";import{c as xt,a as L,b as vt,F as Gt,d as Yt,e as Jt,E as Qt,u as Xt}from"./index.esm-d00cfd11.js";import{G as yt}from"./iconBase-631ea9cd.js";import{H as er,s as tr,a as rr,T as $t,M as nr,b as ir,c as or,t as ar,P as sr,d as lr,e as cr,A as dr,f as ur,g as pr}from"./PetsData.styled-56ed0b20.js";const mr=p.div`
  margin: 0 auto;
  padding-left: 20px;
  padding-right: 20px;
  padding-top: 61px;
...
`,Dr=p.div`
  ...
  font-size: 9px;
  margin-left: 15px;
`,Ar=p.div``,ne=({isBtnDisabled:e,setIsBtnDisabled:t,name:r,type:n,defaultValue:o})=>{const i=J(),[l,c]=m.useState(!1),[g,d]=m.useState(o??""),[x,b]=m.useState(!1),D=k=>{d(k.target.value),b(Qe.fields[r].isValidSync(k.target.value))},y=()=>{b(!0),c(!0),t(!0)},O=()=>{if(t(!0),g===o){b(!1),c(!1),t(!1);return}const k={[r]:g};i(Wt(k)),c(!1),t(!1)};return a(Yt,{initialValues:{[r]:o??""},validationSchema:Qe,children:k=>f(wr,{children:[f(Ar,{children:[a(Jt,{as:$r,name:r,type:n,value:k.values[r],disabled:!l,onChange:S=>{D(S),k.handleChange(S)}}),a(Qt,{component:Dr,name:r})]}),l?a(Xe,{type:"submit",disabled:!x,onClick:O,children:a(yr,{})}):a(Xe,{type:"button",onClick:y,disabled:e,children:a(vr,{})})]})})},kr=p.div`
  display: flex;
...
`,Hn=({onClose:e})=>{m.useEffect(()=>{const v=z=>{z.code==="Escape"&&e()};return window.addEventListener("keydown",v),()=>{window.removeEventListener("keydown",v)}},[e]);const t=v=>{v.currentTarget===v.target&&e()},r=J(),[n,o]=m.useState(1),[i,l]=m.useState(""),{isAdding:c}=H(Rn),g=v=>{o(n+v)},{handleSubmit:d,handleBlur:x,values:b,handleChange:D,errors:y,touched:O}=Xt({initialValues:{name:"",date:"",breed:"",image:"",comments:""},validationSchema:Mr,onSubmit:v=>{const z=new FormData;for(let j in v)v[j].length>0&&z.append(j,v[j]);i&&z.set("image",i),r(Kt(z)),e()}}),[k,S]=m.useState([]),{getRootProps:_,getInputProps:T,isDragActive:R}=jt({maxFiles:1,accept:{"image/*":[".png",".jpg"]},onDrop:v=>{if(v[0].size>5242880){M.warning("Image size bigger than 5MB"),M.info("Please add file less than 5MB");return}S(v.map(z=>Object.assign(z,{preview:URL.createObjectURL(z)}))),l(v[0])}});return f(q,{children:[a(Me,{}),a(nr,{children:a(Un,{onClick:t,children:a(Mn,{secondPage:n===2,children:f("form",{onSubmit:d,children:[a(Bn,{type:"button",onClick:e,children:a(ir,{})}),a("h3",{children:"Add pet"}),f(mt,{isHidden:n===2,isEmpty:b.date==="",children:[f("label",{children:["Name pet",a("input",{type:"text",name:"name",value:b.name,placeholder:"Type name pet",onChange:D,onBlur:x}),y.name||O.name?a("p",{children:y.name}):null]}),f("label",{children:["Date of birth",a("input",{type:"date",name:"date",value:b.date,min:"1900-01-01",max:wt,placeholder:"Type date of birth",onChange:D,onBlur:x}),y.date||O.date?a("p",{children:b.date?y.date:"Date must be a valid"}):null]}),f("label",{children:["Breed",a("input",{type:"text",name:"breed",value:b.breed,placeholder:"Type breed",onChange:D,onBlur:x}),y.breed||O.breed?a("p",{children:y.breed}):null]}),f(ft,{children:[a(ht,{type:"button",onClick:e,children:"Cancel"}),a(Re,{type:"button",onClick:()=>{const{name:v,date:z,breed:j}=b;if(!v||v.length<2||v.length>16||!z||!j||j.length<2||j.length>16||y.breed||y.name){M.info("Please fill in required fields");return}g(1)},children:"Next"})]})]}),f(mt,{isHidden:n===1,children:[a("h4",{children:"Add photo and some comments"}),f(Ln,{..._(),children:[a("input",{...T(),name:"image",value:b.image}),a(Wn,{children:R?null:f(q,{children:[a($t,{}),a("span",{children:"Click or Drop file"})]})}),a("div",{children:k.map(v=>a("div",{children:a("img",{src:v.preview,alt:"pet-avatar"})},v))})]}),f("label",{children:["Comments",a("textarea",{name:"comments",value:b.comments,placeholder:"Type comments",onChange:D,onBlur:x}),y.comments||O.comments?a("p",{children:y.comments}):null]}),f(ft,{children:[a(ht,{type:"button",onClick:()=>{g(-1)},children:"Back"}),a(Re,{type:"submit",onClick:()=>{const{comments:v}=b;if(!v||v.length<8||v.length>120){M.info("Please fill in required fields");return}M.success("Hooray, pet added successfully")},disabled:c,children:"Done"})]})]})]})})})})]})},qn=p.div`
  &:not(:last-child) {
    margin-bottom: 20px;
    @media ${e=>e.theme.media.desktop} {
      margin-bottom: 22px;
