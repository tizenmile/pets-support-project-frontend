...
`,Ht=({onClose:e,deleteNotice:i})=>(c.useEffect(()=>{const a=l=>{l.code==="Escape"&&e()};return window.addEventListener("keydown",a),()=>{window.removeEventListener("keydown",a)}},[e]),t(fe,{children:t(xe,{onClick:a=>{a.currentTarget===a.target&&e()},children:r(Ot,{children:[t("h3",{style:{textAlign:"center"},children:"Are you sure?"}),r(_t,{children:[t(be,{onClick:e,children:"Cancel"}),t(be,{onClick:i,children:"Delete notice"})]})]})})})),ye=({item:e})=>{const i=w(Fe),n=w(oe),a=w(ne),l=w(nt),h=w(Ve),[s,p]=c.useState(!1),[f,m]=c.useState(!1),[d,x]=c.useState(!1),y=R(),I=()=>{p(!0)},g=()=>{m(S=>!S)},C=S=>{p(!1),x(S),a==="fav-notice"&&!S&&y(ge(e._id))},N=i.reduce((S,re)=>(S.push(re._id),S),[]);c.useEffect(()=>{x(N.includes(e._id))},[i]);const z=()=>{x(S=>!S),y(d?Se(e._id):$e(e._id)),a==="fav-notice"&&y(ge(e._id))},B=()=>{y(Xe(e._id)),y(Ze(e._id)),g()},P=l._id?l:h,Y=()=>t("div",{children:t(Ie,{to:"/login",children:"You need to log in"})}),k=parseInt(new Date().getFullYear())-parseInt(new Date(e.birthDate).getFullYear()),J=["One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen"];let D;k<1?D="Less than a year":k>15?D="very old pet":k>=1&&k<=15?D=J[k-1]:D="unknown";const U=e.category;return r(gt,{children:[r(ut,{children:[r("div",{style:{flexGrow:1},children:[r(bt,{children:[t(wt,{src:e.photo,alt:e.title}),r(yt,{children:[U==="sell"&&"sell",U==="for-free"&&"in good hands",U==="lost-found"&&"lost/found"]}),t(vt,{onClick:()=>{n?z():j(Y)},children:d?t("img",{src:Ee,alt:"heartFull"}):t("img",{src:Ae,alt:"heart"})}),t(H,{})]}),t(Nt,{style:{width:"280px"},children:e.title}),r(kt,{children:[e.breed&&r(V,{children:[t(A,{style:{width:"50px"},children:"Breed:"}),t(A,{style:{marginLeft:"40px"},children:e.breed})]}),r(V,{children:[t(A,{style:{width:"50px"},children:"Place:"}),t(A,{style:{marginLeft:"40px"},children:e.place})]}),e.birthDate&&r(V,{children:[t(A,{style:{width:"50px"},children:"Age:"}),t(A,{style:{marginLeft:"40px"},children:D})]}),a!=="lost-found"&&a!=="for-free"&&r(V,{children:[t(A,{style:{width:"50px"},children:"Price:"}),t(A,{style:{marginLeft:"40px"},children:`${e.price}₴`})]})]})]}),t(ue,{style:e.userId!==P._id?{marginBottom:"32px"}:{marginBottom:"12px"},onClick:I,children:"Learn more"}),e.userId==P._id&&n&&r(ue,{onClick:g,children:["Delete",t(rt,{width:"16px",height:"17px"})]})]}),s&&t(jt,{itemId:e._id,isFavorite:d,onClose:C}),f&&t(Ht,{onClose:g,deleteNotice:B})]})},Rt=o.ul`
  max-width: 1248px;
  margin-left: auto;
  margin-right: auto;
  background-color: #fdf7f2;
...
`;function pi(){return JSON.parse(window.localStorage.getItem("noticeNextPart"))}const hi=({onClose:e,isPrev:i,notice:n})=>{const a=pi(),l=w(b=>b.auth.token),h=c.useRef(null),[s,p]=c.useState(a?a.sex:""),[f,m]=c.useState(a?a.place:""),[d,x]=c.useState(a?a.price:""),[y,I]=c.useState(a?a.image:{}),[g,C]=c.useState(a?a.imageName:null),[N,z]=c.useState(a?a.imageUrl:null),[B,P]=c.useState(a?a.comments:""),[Y,v]=c.useState(!1),k=R();c.useEffect(()=>{localStorage.setItem("noticeNextPart",JSON.stringify({image:y,imageName:g,imageUrl:N,sex:s,place:f,price:d,comments:B}))},[B,y,g,N,s,f,d]),c.useEffect(()=>{const b=u=>{u.code==="Escape"&&e()};return window.addEventListener("keydown",b),()=>{window.removeEventListener("keydown",b)}},[e]);const J=b=>{p(b.target.value)},D=b=>{m(b.target.value)},U=b=>{x(b.target.value)},S=b=>{const{files:u}=b.target;if(u[0].size>5242880)return Ge();I(u[0]),u[0]&&C(u[0].name),u&&z(URL.createObjectURL(u[0]))},re=b=>{P(b.target.value)},_e=()=>{h.current.click()},He=async b=>{v(!0),b.preventDefault();const u=new FormData;u.append("image",y),u.append("sex",s),u.append("place",f),u.append("price",d||1),u.append("comments",B),u.append("title",n.title),u.append("breed",n.breed),u.append("birthDate",n.birthDate),u.append("category",n.category),u.append("name",n.name);try{await Le.post("https://pet.tizenmile.keenetic.pro/api/notices/notice",u,{headers:{Authorization:`Bearer ${l}`}}),k(ze()),localStorage.removeItem("notice"),localStorage.removeItem("noticeNextPart"),Re(),e(),Ue()}catch(qe){Ye(qe.response.data.message[0].message)}v(!1)},Re=()=>{z(null),C(null),I(null),p(""),m(""),x(""),P("")},Ye=b=>j.error(b),Ue=()=>j.success("Notice created!"),Ge=()=>j.error("The file must not exceed 5.2 mb!");return r(L,{children:[t(H,{}),Y?t(X,{}):t(L,{children:r(ti,{name:"newForm",onSubmit:He,children:[t(Pe,{type:"button",onClick:e,children:t(De,{src:me})}),t(We,{children:"Add pet"}),t(ii,{children:"The sex*:"}),r(oi,{children:[r(Ne,{children:[t(Ce,{type:"radio",name:"sex",id:"male",checked:s==="male",value:"male",onChange:J}),r(pe,{htmlFor:"male",children:[t(ke,{src:mt}),"Male"]})]}),r(Ne,{children:[t(Ce,{type:"radio",name:"sex",id:"female",checked:s==="female",value:"female",onChange:J}),r(pe,{htmlFor:"female",children:[t(ke,{src:ft}),"Female"]})]})]}),r(je,{children:[t(E,{children:r(O,{children:[r("p",{children:["Location",t("span",{style:{color:"#F59256"},children:"*"}),":"]}),t(_,{type:"",placeholder:"Type location",name:"place",value:f,onChange:D})]})}),n.category==="sell"&&t(E,{children:r(O,{children:["Price",t("span",{style:{color:"#F59256"},children:"*"}),":",t(_,{type:"number",pattern:"[1-9]*[.]?[1-9]+",placeholder:"Type price",name:"price",value:d,onChange:U})]})}),t(E,{children:r(ni,{children:["Load the pet’s image:",t(ri,{type:"button",onClick:_e,children:N?t(si,{src:N}):t(ai,{src:xt})}),t(li,{type:"file",name:"image",ref:h,accept:"image/*,.png,.jpg,.gif,.web",onChange:S})]})}),t(E,{children:r(di,{children:[r("p",{style:{fontSize:"18px"},children:["Comments",t("span",{style:{color:"#F59256"},children:"*"}),":"]}),t(ci,{type:"text",minlength:"8",maxlength:"120",required:!0,placeholder:"Type breed",name:"comments",value:B,onChange:re})]})})]}),r(Oe,{children:[t(te,{children:t(ie,{onClick:i,children:"Back"})}),t(te,{children:t(ie,{style:{color:"#fff",backgroundColor:"#F59256"},type:"submit",children:"Done"})})]})]})})]})},mi=({onClose:e})=>{const[i,n]=c.useState(!1),[a,l]=c.useState(null);return t(fe,{children:t(xe,{onClick:m=>{m.currentTarget===m.target&&e()},children:i?t(hi,{onClose:e,isPrev:()=>{n(!1)},notice:a}):t(ei,{onClose:e,isNext:()=>{n(!0)},onSubmit:m=>{l(m)}})})})},fi=o.div`
  min-width: 132px;
