import{s as p,e as G,r as m,a,j as f,h as Lt,i as Wt,d as U,A as gt,F as oe,Q as L,k as Ut,p as h,l as Ht,m as qt,n as Kt,o as Nt,q as Vt}from"./index-c330c28d.js";import{c as bt,a as M,b as xt,F as Zt,d as Gt,E as Yt,u as Jt}from"./index.esm-f82b14cd.js";import{G as vt}from"./iconBase-c12015c5.js";import{H as Qt,s as Xt,a as er,T as yt,M as tr,b as rr,c as nr,t as ir,P as or,d as ar,e as sr,A as lr,f as cr,g as dr}from"./PetsData.styled-d7065390.js";const ur=p.div`
  margin: 0 auto;
  padding-left: 20px;
  padding-right: 20px;
  padding-top: 61px;
...
`,$r=p.div`
  ...
  font-size: 9px;
  margin-left: 15px;
`,wr=p.div``,re=({isBtnDisabled:e,setIsBtnDisabled:t,name:r,type:n,defaultValue:o})=>{const i=G(),[l,c]=m.useState(!1),[g,d]=m.useState(o??""),[x,b]=m.useState(!1),D=k=>{d(k.target.value),b(Je.fields[r].isValidSync(k.target.value))},$=()=>{b(!0),c(!0),t(!0)},O=()=>{if(t(!0),g===o){b(!1),c(!1),t(!1);return}const k={[r]:g};console.log(k),i(Lt(k)),c(!1),t(!1)};return a(Zt,{initialValues:{[r]:o??""},validationSchema:Je,children:k=>f(yr,{children:[f(wr,{children:[a(Gt,{as:vr,name:r,type:n,value:k.values[r],disabled:!l,onChange:S=>{D(S),k.handleChange(S)}}),a(Yt,{component:$r,name:r})]}),l?a(Qe,{type:"submit",disabled:!x,onClick:O,children:a(xr,{})}):a(Qe,{type:"button",onClick:$,disabled:e,children:a(br,{})})]})})},Dr=p.div`
  display: flex;
...
`;const Pr=()=>{const e=G();m.useEffect(()=>{e(Wt())},[e]);const t=U(Xt),{name:r,email:n,mobile:o,birthday:i,city:l,avatarURL:c}=t,[g,d]=m.useState(),[x,b]=m.useState(""),[D,$]=m.useState(!1),O=U(er);return m.useEffect(()=>{b(c)}),a(Dr,{children:O?a(gt,{}):f(oe,{children:[f(Ar,{children:[g?a(Xe,{id:"img_container",src:g,alt:"avatar"}):a(Xe,{id:"img_container",src:x,alt:"avatar"}),f(kr,{children:[a(Er,{children:a("form",{children:a("input",{name:"userAvatar",type:"file",id:"userAvatar",accept:"image/jpg, image/png, image/jpeg, image/bmp",onChange:S=>{const T=new FileReader;if(S.target.files[0].size>5242880){L.error("Image size bigger than 5MB");return}S.target.files[0]&&(T.readAsDataURL(S.target.files[0]),T.onloadend=()=>{const _=T.result;if(_.includes("image/png")||_.includes("image/jpg")||_.includes("image/jpeg")){d(_);const R=new FormData;R.append("image",S.target.files[0]),e(Ut(R))}})}})})}),f(Or,{htmlFor:"userAvatar",children:[a(zr,{}),"Edit photo"]})]})]}),a(Sr,{children:a(Z,{children:a(V,{children:f(Fr,{children:[f(Z,{children:[a(ne,{children:"Name:"}),a(V,{children:a(re,{isBtnDisabled:D,setIsBtnDisabled:$,defaultValue:r,name:"name",type:"text"})})]}),f(Z,{children:[a(ne,{children:"Email:"}),a(V,{children:a(re,{isBtnDisabled:D,setIsBtnDisabled:$,defaultValue:n,name:"email",type:"email"})})]}),f(Z,{children:[a(ne,{children:"Birthday:"}),a(V,{children:a(re,{isBtnDisabled:D,setIsBtnDisabled:$,defaultValue:i,name:"birthday",type:"date"})})]}),f(Z,{children:[a(ne,{children:"Phone:"}),a(V,{children:a(re,{isBtnDisabled:D,setIsBtnDisabled:$,defaultValue:o,name:"mobile",type:"tel"})})]}),f(Z,{children:[a(ne,{children:"City:"}),a(V,{children:a(re,{isBtnDisabled:D,setIsBtnDisabled:$,defaultValue:l,name:"city",type:"text"})})]})]})})})})]})})},Cr=()=>f(oe,{children:[a(mr,{children:a(fr,{children:"My information:"})}),a(Pr,{})]}),jr=p.button`
  display: flex;
  cursor: pointer;
  width: 40px;
  height: 40px;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Ft(e,t){if(e){if(typeof e=="string")return Ie(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);if(r==="Object"&&e.constructor&&(r=e.constructor.name),r==="Map"||r==="Set")return Array.from(e);if(r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r))return Ie(e,t)}}function Ie(e,t){(t==null||t>e.length)&&(t=e.length);for(var r=0,n=new Array(t);r<t;r++)n[r]=e[r];return n}function zn(e,t){var r=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(r!=null){var n=[],o=!0,i=!1,l,c;try{for(r=r.call(e);!(o=(l=r.next()).done)&&(n.push(l.value),!(t&&n.length===t));o=!0);}catch(g){i=!0,c=g}finally{try{!o&&r.return!=null&&r.return()}finally{if(i)throw c}}return n}}function On(e){if(Array.isArray(e))return e}function dt(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),r.push.apply(r,n)}return r}function y(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]!=null?arguments[t]:{};t%2?dt(Object(r),!0).forEach(function(n){_e(e,n,r[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):dt(Object(r)).forEach(function(n){Object.defineProperty(e,n,Object.getOwnPropertyDescriptor(r,n))})}return e}function _e(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function ye(e,t){if(e==null)return{};var r=Sn(e,t),n,o;if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(e);for(o=0;o<i.length;o++)n=i[o],!(t.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(e,n)&&(r[n]=e[n])}return r}function Sn(e,t){if(e==null)return{};var r={},n=Object.keys(e),o,i;for(i=0;i<n.length;i++)o=n[i],!(t.indexOf(o)>=0)&&(r[o]=e[o]);return r}var Me=m.forwardRef(function(e,t){var r=e.children,n=ye(e,xn),o=Ct(n),i=o.open,l=ye(o,vn);return m.useImperativeHandle(t,function(){return{open:i}},[i]),Ht.createElement(m.Fragment,null,r(y(y({},l),{},{open:i})))});Me.displayName="Dropzone";var Pt={disabled:!1,getFilesFromEvent:Lr,maxSize:1/0,minSize:0,multiple:!0,maxFiles:0,preventDropOnDocument:!0,noClick:!1,noKeyboard:!1,noDrag:!1,noDragEventsBubbling:!1,validator:null,useFsAccessApi:!0,autoFocus:!1};Me.defaultProps=Pt;Me.propTypes={children:h.func,accept:h.objectOf(h.arrayOf(h.string)),multiple:h.bool,preventDropOnDocument:h.bool,noClick:h.bool,noKeyboard:h.bool,noDrag:h.bool,noDragEventsBubbling:h.bool,minSize:h.number,maxSize:h.number,maxFiles:h.number,disabled:h.bool,getFilesFromEvent:h.func,onFileDialogCancel:h.func,onFileDialogOpen:h.func,useFsAccessApi:h.bool,autoFocus:h.bool,onDragEnter:h.func,onDragLeave:h.func,onDragOver:h.func,onDrop:h.func,onDropAccepted:h.func,onDropRejected:h.func,onError:h.func,validator:h.func};var Te={isFocused:!1,isFileDialogActive:!1,isDragActive:!1,isDragAccept:!1,isDragReject:!1,acceptedFiles:[],fileRejections:[]};function Ct(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},t=y(y({},Pt),e),r=t.accept,n=t.disabled,o=t.getFilesFromEvent,i=t.maxSize,l=t.minSize,c=t.multiple,g=t.maxFiles,d=t.onDragEnter,x=t.onDragLeave,b=t.onDragOver,D=t.onDrop,$=t.onDropAccepted,O=t.onDropRejected,k=t.onFileDialogCancel,S=t.onFileDialogOpen,T=t.useFsAccessApi,_=t.autoFocus,R=t.preventDropOnDocument,se=t.noClick,Q=t.noKeyboard,v=t.noDrag,A=t.noDragEventsBubbling,j=t.onError,X=t.validator,ee=m.useMemo(function(){return hn(r)},[r]),Be=m.useMemo(function(){return fn(r)},[r]),$e=m.useMemo(function(){return typeof S=="function"?S:ut},[S]),le=m.useMemo(function(){return typeof k=="function"?k:ut},[k]),z=m.useRef(null),C=m.useRef(null),It=m.useReducer(Fn,Te),Le=Pe(It,2),we=Le[0],F=Le[1],_t=we.isFocused,We=we.isFileDialogActive,ce=m.useRef(typeof window<"u"&&window.isSecureContext&&T&&mn()),Ue=function(){!ce.current&&We&&setTimeout(function(){if(C.current){var u=C.current.files;u.length||(F({type:"closeDialog"}),le())}},300)};m.useEffect(function(){return window.addEventListener("focus",Ue,!1),function(){window.removeEventListener("focus",Ue,!1)}},[C,We,le,ce]);var H=m.useRef([]),He=function(u){z.current&&z.current.contains(u.target)||(u.preventDefault(),H.current=[])};m.useEffect(function(){return R&&(document.addEventListener("dragover",ct,!1),document.addEventListener("drop",He,!1)),function(){R&&(document.removeEventListener("dragover",ct),document.removeEventListener("drop",He))}},[z,R]),m.useEffect(function(){return!n&&_&&z.current&&z.current.focus(),function(){}},[z,_,n]);var B=m.useCallback(function(s){j?j(s):console.error(s)},[j]),qe=m.useCallback(function(s){s.preventDefault(),s.persist(),me(s),H.current=[].concat(wn(H.current),[s.target]),he(s)&&Promise.resolve(o(s)).then(function(u){if(!(ve(s)&&!A)){var w=u.length,E=w>0&&cn({files:u,accept:ee,minSize:l,maxSize:i,multiple:c,maxFiles:g,validator:X}),P=w>0&&!E;F({isDragAccept:E,isDragReject:P,isDragActive:!0,type:"setDraggedFiles"}),d&&d(s)}}).catch(function(u){return B(u)})},[o,d,B,A,ee,l,i,c,g,X]),Ke=m.useCallback(function(s){s.preventDefault(),s.persist(),me(s);var u=he(s);if(u&&s.dataTransfer)try{s.dataTransfer.dropEffect="copy"}catch{}return u&&b&&b(s),!1},[b,A]),Ne=m.useCallback(function(s){s.preventDefault(),s.persist(),me(s);var u=H.current.filter(function(E){return z.current&&z.current.contains(E)}),w=u.indexOf(s.target);w!==-1&&u.splice(w,1),H.current=u,!(u.length>0)&&(F({type:"setDraggedFiles",isDragActive:!1,isDragAccept:!1,isDragReject:!1}),he(s)&&x&&x(s))},[z,x,A]),de=m.useCallback(function(s,u){var w=[],E=[];s.forEach(function(P){var te=Et(P,ee),N=Pe(te,2),Ae=N[0],ke=N[1],Ee=zt(P,l,i),fe=Pe(Ee,2),ze=fe[0],Oe=fe[1],Se=X?X(P):null;if(Ae&&ze&&!Se)w.push(P);else{var Fe=[ke,Oe];Se&&(Fe=Fe.concat(Se)),E.push({file:P,errors:Fe.filter(function(Bt){return Bt})})}}),(!c&&w.length>1||c&&g>=1&&w.length>g)&&(w.forEach(function(P){E.push({file:P,errors:[ln]})}),w.splice(0)),F({acceptedFiles:w,fileRejections:E,type:"setFiles"}),D&&D(w,E,u),E.length>0&&O&&O(E,u),w.length>0&&$&&$(w,u)},[F,c,ee,l,i,g,D,$,O,X]),ue=m.useCallback(function(s){s.preventDefault(),s.persist(),me(s),H.current=[],he(s)&&Promise.resolve(o(s)).then(function(u){ve(s)&&!A||de(u,s)}).catch(function(u){return B(u)}),F({type:"reset"})},[o,de,B,A]),q=m.useCallback(function(){if(ce.current){F({type:"openDialog"}),$e();var s={multiple:c,types:Be};window.showOpenFilePicker(s).then(function(u){return o(u)}).then(function(u){de(u,null),F({type:"closeDialog"})}).catch(function(u){gn(u)?(le(u),F({type:"closeDialog"})):bn(u)?(ce.current=!1,C.current?(C.current.value=null,C.current.click()):B(new Error("Cannot open the file picker because the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API is not supported and no <input> was provided."))):B(u)});return}C.current&&(F({type:"openDialog"}),$e(),C.current.value=null,C.current.click())},[F,$e,le,T,de,B,Be,c]),Ve=m.useCallback(function(s){!z.current||!z.current.isEqualNode(s.target)||(s.key===" "||s.key==="Enter"||s.keyCode===32||s.keyCode===13)&&(s.preventDefault(),q())},[z,q]),Ze=m.useCallback(function(){F({type:"focus"})},[]),Ge=m.useCallback(function(){F({type:"blur"})},[]),Ye=m.useCallback(function(){se||(pn()?setTimeout(q,0):q())},[se,q]),K=function(u){return n?null:u},De=function(u){return Q?null:K(u)},pe=function(u){return v?null:K(u)},me=function(u){A&&u.stopPropagation()},Tt=m.useMemo(function(){return function(){var s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},u=s.refKey,w=u===void 0?"ref":u,E=s.role,P=s.onKeyDown,te=s.onFocus,N=s.onBlur,Ae=s.onClick,ke=s.onDragEnter,Ee=s.onDragOver,fe=s.onDragLeave,ze=s.onDrop,Oe=ye(s,yn);return y(y(_e({onKeyDown:De(I(P,Ve)),onFocus:De(I(te,Ze)),onBlur:De(I(N,Ge)),onClick:K(I(Ae,Ye)),onDragEnter:pe(I(ke,qe)),onDragOver:pe(I(Ee,Ke)),onDragLeave:pe(I(fe,Ne)),onDrop:pe(I(ze,ue)),role:typeof E=="string"&&E!==""?E:"presentation"},w,z),!n&&!Q?{tabIndex:0}:{}),Oe)}},[z,Ve,Ze,Ge,Ye,qe,Ke,Ne,ue,Q,v,n]),Rt=m.useCallback(function(s){s.stopPropagation()},[]),Mt=m.useMemo(function(){return function(){var s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},u=s.refKey,w=u===void 0?"ref":u,E=s.onChange,P=s.onClick,te=ye(s,$n),N=_e({accept:ee,multiple:c,type:"file",style:{display:"none"},onChange:K(I(E,ue)),onClick:K(I(P,Rt)),tabIndex:-1},w,C);return y(y({},N),te)}},[C,r,c,ue,n]);return y(y({},we),{},{isFocused:_t&&!n,getRootProps:Tt,getInputProps:Mt,rootRef:z,inputRef:C,open:K(q)})}function Fn(e,t){switch(t.type){case"focus":return y(y({},e),{},{isFocused:!0});case"blur":return y(y({},e),{},{isFocused:!1});case"openDialog":return y(y({},Te),{},{isFileDialogActive:!0});case"closeDialog":return y(y({},e),{},{isFileDialogActive:!1});case"setDraggedFiles":return y(y({},e),{},{isDragActive:t.isDragActive,isDragAccept:t.isDragAccept,isDragReject:t.isDragReject});case"setFiles":return y(y({},e),{},{acceptedFiles:t.acceptedFiles,fileRejections:t.fileRejections});case"reset":return y({},Te);default:return e}}function ut(){}const Pn=e=>e.pets.pets,Cn=e=>e.pets.isLoading,jn=e=>e.pets.error,In=e=>e.pets.isDeleting,_n=e=>e.pets.isAdding,Tn=p.div`
  position: relative;
  width: 280px;
  padding: 40px 20px;
  font-family: ${e=>e.theme.fonts.main};
...
`,Wn=({onClose:e})=>{m.useEffect(()=>{const v=A=>{A.code==="Escape"&&e()};return window.addEventListener("keydown",v),()=>{window.removeEventListener("keydown",v)}},[e]);const t=v=>{v.currentTarget===v.target&&e()},r=G(),[n,o]=m.useState(1),[i,l]=m.useState(""),{isAdding:c}=U(_n),g=v=>{o(n+v)},{handleSubmit:d,handleBlur:x,values:b,handleChange:D,errors:$,touched:O}=Jt({initialValues:{name:"",date:"",breed:"",image:"",comments:""},validationSchema:Tr,onSubmit:v=>{const A=new FormData;for(let j in v)v[j].length>0&&A.append(j,v[j]);i&&A.set("image",i),r(qt(A)),e()}}),[k,S]=m.useState([]),{getRootProps:T,getInputProps:_,isDragActive:R}=Ct({maxFiles:1,accept:{"image/*":[".png",".jpg"]},onDrop:v=>{if(v[0].size>5242880){L.warning("Image size bigger than 5MB"),L.info("Please add file less than 5MB");return}S(v.map(A=>Object.assign(A,{preview:URL.createObjectURL(A)}))),l(v[0])}}),{name:se,breed:Q}=b;return console.log(se.length,Q),a(tr,{children:a(Ln,{onClick:t,children:a(Tn,{secondPage:n===2,children:f("form",{onSubmit:d,children:[a(Mn,{type:"button",onClick:e,children:a(rr,{})}),a("h3",{children:"Add pet"}),f(pt,{isHidden:n===2,isEmpty:b.date==="",children:[f("label",{children:["Name pet",a("input",{type:"text",name:"name",value:b.name,placeholder:"Type name pet",onChange:D,onBlur:x}),$.name||O.name?a("p",{children:$.name}):null]}),f("label",{children:["Date of birth",a("input",{type:"date",name:"date",value:b.date,min:"2000-01-01",max:$t,placeholder:"Type date of birth",onChange:D,onBlur:x}),$.date||O.date?a("p",{children:b.date?$.date:"Date must be a valid"}):null]}),f("label",{children:["Breed",a("input",{type:"text",name:"breed",value:b.breed,placeholder:"Type breed",onChange:D,onBlur:x}),$.breed||O.breed?a("p",{children:$.breed}):null]}),f(mt,{children:[a(ft,{type:"button",onClick:e,children:"Cancel"}),a(Re,{type:"button",onClick:()=>{const{name:v,date:A,breed:j}=b;if(!v||v.length<2||v.length>16||!A||!j||j.length<2||j.length>16){L.info("Please fill in required fields");return}g(1)},children:"Next"})]})]}),f(pt,{isHidden:n===1,children:[a("h4",{children:"Add photo and some comments"}),f(Rn,{...T(),children:[a("input",{..._(),name:"image",value:b.image}),a(Bn,{children:R?null:f(oe,{children:[a(yt,{}),a("span",{children:"Click or Drop file"})]})}),a("div",{children:k.map(v=>a("div",{children:a("img",{src:v.preview,alt:"pet-avatar"})},v))})]}),f("label",{children:["Comments",a("textarea",{name:"comments",value:b.comments,placeholder:"Type comments",onChange:D,onBlur:x}),$.comments||O.comments?a("p",{children:$.comments}):null]}),f(mt,{children:[a(ft,{type:"button",onClick:()=>{g(-1)},children:"Back"}),a(Re,{type:"submit",onClick:()=>{const{comments:v}=b;if(!v||v.length<8||v.length>120){L.info("Please fill in required fields");return}L.success("Hooray, pet added successfully")},disabled:c,children:"Done"})]})]})]})})})})},Un=p.div`
  &:not(:last-child) {
    margin-bottom: 20px;
    @media ${e=>e.theme.media.desktop} {
      margin-bottom: 22px;
...
`,jt=({id:e,name:t,date:r,breed:n,comment:o,petAvatar:i})=>{const{isDeleting:l}=U(In),c=G(),g=d=>{c(Kt(d)).unwrap()};return f(Un,{children:[a(Hn,{src:i,alt:`${t}`}),f(qn,{children:[a(Kn,{type:"button",onClick:()=>{L.info("Hooray, pet delete successfully"),g(e)},disabled:l,children:a(Nn,{})}),f(ge,{children:[a(be,{children:"Name: "}),t]}),f(ge,{children:[a(be,{children:"Date of birth: "}),ir(r)]}),f(ge,{children:[a(be,{children:"Breed: "}),n]}),f(ge,{children:[a(be,{children:"Comments: "}),o]})]})]})};jt.prototype={id:h.string.isRequired,name:h.string.isRequired,date:h.string.isRequired,breed:h.string.isRequired,comments:h.string.isRequired,petAvatar:h.string.isRequired,removePet:h.func};const ht=p.div`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Yn=p(dr)`
  ...
  margin-right: ${e=>e.theme.space[3]}px;
  color: ${e=>e.theme.colors.accent};
`,Jn=()=>{const e=G();return f(Gn,{type:"button",onClick:()=>e(Vt()),children:[a(Yn,{}),"Log Out"]})},ri=()=>f(ur,{children:[f(pr,{children:[a(Cr,{}),a(Jn,{})]}),a(Zn,{})]});export{ri as default};
