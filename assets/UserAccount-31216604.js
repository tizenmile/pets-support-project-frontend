import{s as u,e as Y,r as m,j as a,a as f,h as Mt,i as Lt,d as U,A as gt,F as ie,k as Wt,p as h,l as Ut,Q as Ht,m as qt,n as Kt,o as Nt,q as Vt}from"./index-e6188c2c.js";import{c as bt,a as B,b as xt,F as Gt,d as Yt,e as Zt,E as Jt,u as Qt}from"./index.esm-b3600b58.js";import{G as ve}from"./iconBase-f39ac5a8.js";import{H as Xt,M as en,a as tn,b as nn}from"./ModalBackdrop-85a241af.js";const rn=u.div`
  margin: 0 auto;
  padding-left: 20px;
  padding-right: 20px;
  padding-top: 61px;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Ft(e,t){if(e){if(typeof e=="string")return Ie(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);if(n==="Object"&&e.constructor&&(n=e.constructor.name),n==="Map"||n==="Set")return Array.from(e);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return Ie(e,t)}}function Ie(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=new Array(t);n<t;n++)r[n]=e[n];return r}function $r(e,t){var n=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(n!=null){var r=[],o=!0,i=!1,l,c;try{for(n=n.call(e);!(o=(l=n.next()).done)&&(r.push(l.value),!(t&&r.length===t));o=!0);}catch(g){i=!0,c=g}finally{try{!o&&n.return!=null&&n.return()}finally{if(i)throw c}}return r}}function Dr(e){if(Array.isArray(e))return e}function dt(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),n.push.apply(n,r)}return n}function v(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?dt(Object(n),!0).forEach(function(r){Te(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):dt(Object(n)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function Te(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function xe(e,t){if(e==null)return{};var n=Ar(e,t),r,o;if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(e);for(o=0;o<i.length;o++)r=i[o],!(t.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(e,r)&&(n[r]=e[r])}return n}function Ar(e,t){if(e==null)return{};var n={},r=Object.keys(e),o,i;for(i=0;i<r.length;i++)o=r[i],!(t.indexOf(o)>=0)&&(n[o]=e[o]);return n}var Be=m.forwardRef(function(e,t){var n=e.children,r=xe(e,mr),o=Ct(r),i=o.open,l=xe(o,fr);return m.useImperativeHandle(t,function(){return{open:i}},[i]),Ut.createElement(m.Fragment,null,n(v(v({},l),{},{open:i})))});Be.displayName="Dropzone";var zt={disabled:!1,getFilesFromEvent:_n,maxSize:1/0,minSize:0,multiple:!0,maxFiles:0,preventDropOnDocument:!0,noClick:!1,noKeyboard:!1,noDrag:!1,noDragEventsBubbling:!1,validator:null,useFsAccessApi:!0,autoFocus:!1};Be.defaultProps=zt;Be.propTypes={children:h.func,accept:h.objectOf(h.arrayOf(h.string)),multiple:h.bool,preventDropOnDocument:h.bool,noClick:h.bool,noKeyboard:h.bool,noDrag:h.bool,noDragEventsBubbling:h.bool,minSize:h.number,maxSize:h.number,maxFiles:h.number,disabled:h.bool,getFilesFromEvent:h.func,onFileDialogCancel:h.func,onFileDialogOpen:h.func,useFsAccessApi:h.bool,autoFocus:h.bool,onDragEnter:h.func,onDragLeave:h.func,onDragOver:h.func,onDrop:h.func,onDropAccepted:h.func,onDropRejected:h.func,onError:h.func,validator:h.func};var _e={isFocused:!1,isFileDialogActive:!1,isDragActive:!1,isDragAccept:!1,isDragReject:!1,acceptedFiles:[],fileRejections:[]};function Ct(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},t=v(v({},zt),e),n=t.accept,r=t.disabled,o=t.getFilesFromEvent,i=t.maxSize,l=t.minSize,c=t.multiple,g=t.maxFiles,d=t.onDragEnter,x=t.onDragLeave,b=t.onDragOver,D=t.onDrop,y=t.onDropAccepted,S=t.onDropRejected,E=t.onFileDialogCancel,C=t.onFileDialogOpen,T=t.useFsAccessApi,I=t.autoFocus,_=t.preventDropOnDocument,w=t.noClick,O=t.noKeyboard,R=t.noDrag,M=t.noDragEventsBubbling,ye=t.onError,Q=t.validator,X=m.useMemo(function(){return dr(n)},[n]),Me=m.useMemo(function(){return cr(n)},[n]),we=m.useMemo(function(){return typeof C=="function"?C:ut},[C]),ae=m.useMemo(function(){return typeof E=="function"?E:ut},[E]),k=m.useRef(null),P=m.useRef(null),jt=m.useReducer(Er,_e),Le=Ce(jt,2),$e=Le[0],F=Le[1],It=$e.isFocused,We=$e.isFileDialogActive,se=m.useRef(typeof window<"u"&&window.isSecureContext&&T&&lr()),Ue=function(){!se.current&&We&&setTimeout(function(){if(P.current){var p=P.current.files;p.length||(F({type:"closeDialog"}),ae())}},300)};m.useEffect(function(){return window.addEventListener("focus",Ue,!1),function(){window.removeEventListener("focus",Ue,!1)}},[P,We,ae,se]);var H=m.useRef([]),He=function(p){k.current&&k.current.contains(p.target)||(p.preventDefault(),H.current=[])};m.useEffect(function(){return _&&(document.addEventListener("dragover",ct,!1),document.addEventListener("drop",He,!1)),function(){_&&(document.removeEventListener("dragover",ct),document.removeEventListener("drop",He))}},[k,_]),m.useEffect(function(){return!r&&I&&k.current&&k.current.focus(),function(){}},[k,I,r]);var L=m.useCallback(function(s){ye?ye(s):console.error(s)},[ye]),qe=m.useCallback(function(s){s.preventDefault(),s.persist(),ue(s),H.current=[].concat(br(H.current),[s.target]),me(s)&&Promise.resolve(o(s)).then(function(p){if(!(be(s)&&!M)){var $=p.length,A=$>0&&ir({files:p,accept:X,minSize:l,maxSize:i,multiple:c,maxFiles:g,validator:Q}),z=$>0&&!A;F({isDragAccept:A,isDragReject:z,isDragActive:!0,type:"setDraggedFiles"}),d&&d(s)}}).catch(function(p){return L(p)})},[o,d,L,M,X,l,i,c,g,Q]),Ke=m.useCallback(function(s){s.preventDefault(),s.persist(),ue(s);var p=me(s);if(p&&s.dataTransfer)try{s.dataTransfer.dropEffect="copy"}catch{}return p&&b&&b(s),!1},[b,M]),Ne=m.useCallback(function(s){s.preventDefault(),s.persist(),ue(s);var p=H.current.filter(function(A){return k.current&&k.current.contains(A)}),$=p.indexOf(s.target);$!==-1&&p.splice($,1),H.current=p,!(p.length>0)&&(F({type:"setDraggedFiles",isDragActive:!1,isDragAccept:!1,isDragReject:!1}),me(s)&&x&&x(s))},[k,x,M]),le=m.useCallback(function(s,p){var $=[],A=[];s.forEach(function(z){var ee=Et(z,X),N=Ce(ee,2),Ae=N[0],Ee=N[1],ke=kt(z,l,i),pe=Ce(ke,2),Se=pe[0],Oe=pe[1],Fe=Q?Q(z):null;if(Ae&&Se&&!Fe)$.push(z);else{var ze=[Ee,Oe];Fe&&(ze=ze.concat(Fe)),A.push({file:z,errors:ze.filter(function(Bt){return Bt})})}}),(!c&&$.length>1||c&&g>=1&&$.length>g)&&($.forEach(function(z){A.push({file:z,errors:[rr]})}),$.splice(0)),F({acceptedFiles:$,fileRejections:A,type:"setFiles"}),D&&D($,A,p),A.length>0&&S&&S(A,p),$.length>0&&y&&y($,p)},[F,c,X,l,i,g,D,y,S,Q]),ce=m.useCallback(function(s){s.preventDefault(),s.persist(),ue(s),H.current=[],me(s)&&Promise.resolve(o(s)).then(function(p){be(s)&&!M||le(p,s)}).catch(function(p){return L(p)}),F({type:"reset"})},[o,le,L,M]),q=m.useCallback(function(){if(se.current){F({type:"openDialog"}),we();var s={multiple:c,types:Me};window.showOpenFilePicker(s).then(function(p){return o(p)}).then(function(p){le(p,null),F({type:"closeDialog"})}).catch(function(p){ur(p)?(ae(p),F({type:"closeDialog"})):pr(p)?(se.current=!1,P.current?(P.current.value=null,P.current.click()):L(new Error("Cannot open the file picker because the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API is not supported and no <input> was provided."))):L(p)});return}P.current&&(F({type:"openDialog"}),we(),P.current.value=null,P.current.click())},[F,we,ae,T,le,L,Me,c]),Ve=m.useCallback(function(s){!k.current||!k.current.isEqualNode(s.target)||(s.key===" "||s.key==="Enter"||s.keyCode===32||s.keyCode===13)&&(s.preventDefault(),q())},[k,q]),Ge=m.useCallback(function(){F({type:"focus"})},[]),Ye=m.useCallback(function(){F({type:"blur"})},[]),Ze=m.useCallback(function(){w||(sr()?setTimeout(q,0):q())},[w,q]),K=function(p){return r?null:p},De=function(p){return O?null:K(p)},de=function(p){return R?null:K(p)},ue=function(p){M&&p.stopPropagation()},Tt=m.useMemo(function(){return function(){var s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},p=s.refKey,$=p===void 0?"ref":p,A=s.role,z=s.onKeyDown,ee=s.onFocus,N=s.onBlur,Ae=s.onClick,Ee=s.onDragEnter,ke=s.onDragOver,pe=s.onDragLeave,Se=s.onDrop,Oe=xe(s,hr);return v(v(Te({onKeyDown:De(j(z,Ve)),onFocus:De(j(ee,Ge)),onBlur:De(j(N,Ye)),onClick:K(j(Ae,Ze)),onDragEnter:de(j(Ee,qe)),onDragOver:de(j(ke,Ke)),onDragLeave:de(j(pe,Ne)),onDrop:de(j(Se,ce)),role:typeof A=="string"&&A!==""?A:"presentation"},$,k),!r&&!O?{tabIndex:0}:{}),Oe)}},[k,Ve,Ge,Ye,Ze,qe,Ke,Ne,ce,O,R,r]),_t=m.useCallback(function(s){s.stopPropagation()},[]),Rt=m.useMemo(function(){return function(){var s=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},p=s.refKey,$=p===void 0?"ref":p,A=s.onChange,z=s.onClick,ee=xe(s,gr),N=Te({accept:X,multiple:c,type:"file",style:{display:"none"},onChange:K(j(A,ce)),onClick:K(j(z,_t)),tabIndex:-1},$,P);return v(v({},N),ee)}},[P,n,c,ce,r]);return v(v({},$e),{},{isFocused:It&&!r,getRootProps:Tt,getInputProps:Rt,rootRef:k,inputRef:P,open:K(q)})}function Er(e,t){switch(t.type){case"focus":return v(v({},e),{},{isFocused:!0});case"blur":return v(v({},e),{},{isFocused:!1});case"openDialog":return v(v({},_e),{},{isFileDialogActive:!0});case"closeDialog":return v(v({},e),{},{isFileDialogActive:!1});case"setDraggedFiles":return v(v({},e),{},{isDragActive:t.isDragActive,isDragAccept:t.isDragAccept,isDragReject:t.isDragReject});case"setFiles":return v(v({},e),{},{acceptedFiles:t.acceptedFiles,fileRejections:t.fileRejections});case"reset":return v({},_e);default:return e}}function ut(){}const kr=e=>e.pets.pets,Sr=e=>e.pets.isLoading,Or=e=>e.pets.error,Fr=e=>e.pets.isDeleting,zr=e=>e.pets.isAdding,Cr=u.div`
  position: relative;
  width: 280px;
  padding: 40px 20px;
  background-color: ${e=>e.theme.colors.white};
...
`,_r=({onClose:e})=>{m.useEffect(()=>{const w=O=>{O.code==="Escape"&&e()};return window.addEventListener("keydown",w),()=>{window.removeEventListener("keydown",w)}},[e]);const t=w=>{w.currentTarget===w.target&&e()},n=Y(),[r,o]=m.useState(1),[i,l]=m.useState(""),{isAdding:c}=U(zr),g=w=>{o(r+w)},{handleSubmit:d,handleBlur:x,values:b,handleChange:D,errors:y,touched:S}=Qt({initialValues:{name:"",date:"",breed:"",image:"",comments:""},validationSchema:Pn,onSubmit:w=>{const O=new FormData;for(let R in w)w[R].length>0&&O.append(R,w[R]);i&&O.set("image",i),n(qt(O)),e()}}),[E,C]=m.useState([]),{getRootProps:T,getInputProps:I,isDragActive:_}=Ct({maxFiles:1,accept:{"image/*":[".png",".jpg"]},onDrop:w=>{C(w.map(O=>Object.assign(O,{preview:URL.createObjectURL(O)}))),l(w[0])}});return a(en,{children:a(Tr,{onClick:t,children:a(Cr,{secondPage:r===2,children:f("form",{onSubmit:d,children:[a(jr,{type:"button",onClick:e,children:a(On,{})}),a("h3",{children:"Add pet"}),f(pt,{isHidden:r===2,isEmpty:b.date==="",children:[f("label",{children:["Name pet",a("input",{type:"text",name:"name",value:b.name,placeholder:"Type name pet",onChange:D,onBlur:x}),y.name||S.name?a("p",{children:y.name}):null]}),f("label",{children:["Date of birth",a("input",{type:"date",name:"date",value:b.date,min:"2000-01-01",max:yt,placeholder:"Type date of birth",onChange:D,onBlur:x}),y.date||S.date?a("p",{children:b.date?y.date:"Date must be a valid"}):null]}),f("label",{children:["Breed",a("input",{type:"text",name:"breed",value:b.breed,placeholder:"Type breed",onChange:D,onBlur:x}),y.breed||S.breed?a("p",{children:y.breed}):null]}),f(mt,{children:[a(ft,{type:"button",onClick:e,children:"Cancel"}),a(Re,{type:"button",onClick:()=>{const{name:w,date:O,breed:R}=b;if(!w||!O||!R){Ht.info("Please fill in required fields");return}g(1)},children:"Next"})]})]}),f(pt,{isHidden:r===1,children:[a("h4",{children:"Add photo and some comments"}),f(Pr,{...T(),children:[a("input",{...I(),name:"image",value:b.image}),a(Ir,{children:_?null:f(ie,{children:[a(vt,{}),a("span",{children:"Click or Drop file"})]})}),a("div",{children:E.map(w=>a("div",{children:a("img",{src:w.preview,alt:"pet-avatar"})},w))})]}),f("label",{children:["Comments",a("textarea",{name:"comments",value:b.comments,placeholder:"Type comments",onChange:D,onBlur:x}),y.comments||S.comments?a("p",{children:y.comments}):null]}),f(mt,{children:[a(ft,{type:"button",onClick:()=>{g(-1)},children:"Back"}),a(Re,{type:"submit",disabled:c,children:"Done"})]})]})]})})})})},Rr=e=>{const t=new Date(e),n=t.getDate().toString().padStart(2,"0"),r=(t.getMonth()+1).toString().padStart(2,"0"),o=t.getFullYear();return`${n}.${r}.${o}`},Br=u.div`
  &:not(:last-child) {
    margin-bottom: 20px;
    @media ${e=>e.theme.media.desktop} {
      margin-bottom: 22px;
...
`,Pt=({id:e,name:t,date:n,breed:r,comment:o,petAvatar:i})=>{const{isDeleting:l}=U(Fr),c=Y(),g=d=>{c(Kt(d)).unwrap()};return f(Br,{children:[a(Mr,{src:i,alt:`${t}`}),f(Lr,{children:[a(Wr,{type:"button",disabled:l,onClick:()=>g(e),children:a(Ur,{})}),f(fe,{children:[a(he,{children:"Name: "}),t]}),f(fe,{children:[a(he,{children:"Date of birth: "}),Rr(n)]}),f(fe,{children:[a(he,{children:"Breed: "}),r]}),f(fe,{children:[a(he,{children:"Comments: "}),o]})]})]})};Pt.prototype={id:h.string.isRequired,name:h.string.isRequired,date:h.string.isRequired,breed:h.string.isRequired,comments:h.string.isRequired,petAvatar:h.string.isRequired,removePet:h.func};const ht=u.div`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Hr=()=>{const e=U(kr),t=U(Sr),n=U(Or),r=Y();return m.useEffect(()=>{r(Nt())},[r]),a(ie,{children:t?a(ht,{children:a(gt,{})}):n||e.length===0?a(ht,{children:"Please add your pet"}):!n&&!t&&(e==null?void 0:e.map(({_id:o,name:i,date:l,breed:c,comments:g,petAvatar:d})=>a(Pt,{id:o,name:i,date:l,breed:c,comment:g,petAvatar:d},o)))})},qr=u.section`
  width: 100%;
  @media ${e=>e.theme.media.tablet} {
...
`,Yr=()=>{const[e,t]=m.useState(!0),n=()=>{t(r=>!r)};return f(qr,{children:[f(Kr,{children:[a(Nr,{children:"My pets:"}),f(Vr,{children:[a(Gr,{children:"Add pet"}),a(Cn,{onClick:n})]})]}),!e&&a(_r,{onClose:n}),a(Hr,{})]})},Zr=u.button`
  position: absolute;
  right: 12px;
  bottom: 20px;
  display: inline-flex;
...
`,Jr=u(nn)`
  ...
  margin-right: ${e=>e.theme.space[3]}px;
  color: ${e=>e.theme.colors.accent};
`,Qr=()=>{const e=Y();return f(Zr,{type:"button",onClick:()=>e(Vt()),children:[a(Jr,{}),"Log Out"]})},ri=()=>f(rn,{children:[f(on,{children:[a(Sn,{}),a(Qr,{})]}),a(Yr,{})]});export{ri as default};
