...
`,G=e=>J.info(e,{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"}),$e=K().shape({email:$().max(63,"Must be between 6 and 63 characters.").min(6,"Must be between 6 and 63 characters.").email("Invalid email address").matches(/[a-zA-Z]([-.\s]?[0-9a-zA-Z_-]){1,}@/,"The @ symbol must be preceded by at least 2 characters").required("Email is required").test("is-valid",e=>`${e.path} is invalid`,e=>e?be(e):new me("Invalid value")),password:$().min(7,"Must be between 7 and 32 characters.").max(32,"Must be between 7 and 32 characters.").matches(/^([-.\s]?[a-zA-Zа-яёА-ЯЁ0-9]*)*$/,"Must include numbers and/or letters (uppercase and lowercase) except for whitespace.").matches(/^\S*$/,"Password must not contain spaces").required("Password is required")}),Pe=K().shape({name:$().required("Name is required"),city:$().required("City, region are required"),mobile:$().length(13,"For example +380##########. Must be 13 characters.").matches("^[+](380)[0-9]{9}$","For example +380##########. Must be 13 characters.").required("Mobile phone is required")}),Se={email:"",password:"",name:"",city:"",mobile:""},S=({name:e})=>n(fe,{name:e,render:r=>n(Fe,{children:r})}),Be=()=>{const[e,r]=D.useState(Se),[d,u]=D.useState(0),[i,o]=D.useState(!1),[a,t]=D.useState(!1),s=()=>{o(!i)},m=()=>{t(!a)},c=oe(),p=w=>{const{email:x,password:_,name:f,city:l,mobile:F}=w;c(de({email:x,password:_,name:f,city:l,mobile:F}))},C=(w,x=!1)=>{if(r(_=>({..._,...w})),x){p(w);return}u(_=>_+1)};return k(se,{children:[[n(ke,{next:C,data:e,showPassword:i,togglePassword:()=>s(),showConfirmPassword:a,toggleConfirmPassword:()=>m()}),n(Ee,{next:C,prev:w=>{r(x=>({...x,...w})),u(x=>x-1)},data:e})][d],n(le,{position:"bottom-right",autoClose:5e3,hideProgressBar:!1,newestOnTop:!1,closeOnClick:!0,rtl:!1,pauseOnFocusLoss:!0,draggable:!0,pauseOnHover:!0,theme:"colored"})]})},ke=e=>{const{showPassword:r,togglePassword:d,showConfirmPassword:u,toggleConfirmPassword:i}=e,o=a=>{if(a.email.toLowerCase().includes(".ru")){J.error("Москалей не регистрируем",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"});return}if(!a.confirmPassword){G("Confirm password is required");return}a.confirmPassword===a.password&&e.next(a),a.confirmPassword!==a.password&&G("Passwords must match")};return n(j,{initialValues:e.data,validationSchema:$e,onSubmit:o,children:({values:a})=>k(ee,{children:[n(P,{placeholder:"Email",type:"email",name:"email",value:a.email||""}),n(S,{name:"email"}),k(X,{children:[n(P,{placeholder:"Password",name:"password",value:a.password||"",type:r?"text":"password"}),n(Y,{onClick:d,children:n(Z.Provider,{value:{color:"rgba(245, 146, 86, 1)",size:35},children:r?n(Q,{}):n(W,{})})})]}),n(S,{name:"password"}),k(X,{children:[n(P,{placeholder:"Confirm Password",type:u?"text":"password",name:"confirmPassword",validate:$()}),n(Y,{onClick:i,children:n(Z.Provider,{value:{color:"rgba(245, 146, 86, 1)",size:35},children:u?n(Q,{}):n(W,{})})})]}),n(S,{name:"confirmPassword"}),n(te,{type:"submit",children:"Next"})]})})},Ee=e=>{const r=(d,u)=>{e.next(d,!0)};return n(j,{initialValues:e.data,validationSchema:Pe,onSubmit:r,children:({values:d})=>k(ee,{children:[n(P,{placeholder:"Name",type:"text",name:"name",value:d.name||""}),n(S,{name:"name"}),n(P,{placeholder:"City, region",type:"text",name:"city",value:d.city||""}),n(S,{name:"city"}),n(P,{placeholder:"Mobile phone",type:"text",name:"mobile",value:d.mobile||""}),n(S,{name:"mobile"}),n(te,{type:"submit",children:"Register"}),n(ye,{type:"button",onClick:()=>e.prev(d),children:"Back"})]})})};export{Be as A,S as F,X as P,ze as R,Me as a,Ae as b,Oe as c,Ie as d,Y as e,be as i,ve as l};
