...
`,Ot=({onClose:e,itemId:i,isFavorite:n})=>{const a=w(ne),l=w(re),m=w(Be),[s,p]=c.useState(null),[f,h]=c.useState(n),d=H();c.useEffect(()=>{const g=C=>{C.code==="Escape"&&e()};return window.addEventListener("keydown",g),()=>{window.removeEventListener("keydown",g)}},[e]);const x=g=>{g.currentTarget===g.target&&e()},y=()=>{h(g=>!g),d(f?Ie(i):Fe(i))},I=()=>t("div",{children:t(ze,{to:"/login",children:"You need to log in"})});if(c.useEffect(()=>{Se.get(`https://pet.tizenmile.keenetic.pro/api/notices/notice/${i}`).then(g=>{const C=g.data.data;p(C)})},[]),!!s)return t(fe,{children:t(xe,{onClick:x,children:r(Mt,{children:[t(Lt,{onClick:()=>{e(f),l==="fav-notice"&&d(ee(m))},children:t($t,{src:me,alt:"close_menu_icon"})}),r(St,{children:[r(It,{children:[t(Ft,{src:s.notice.photo}),t(zt,{children:s.notice.category})]}),r("div",{children:[t(Tt,{children:s.notice.title}),r(Bt,{children:[s.notice.name&&r(T,{children:[t(z,{children:"Name:"}),t(W,{children:s.notice.name})]}),s.notice.birthDate&&r(T,{children:[t(z,{children:"Birthday:"}),t(W,{children:nt(s.notice.birthDate)})]}),s.notice.breed&&r(T,{children:[t(z,{children:"Breed:"}),t(W,{children:s.notice.breed})]}),r(T,{children:[t(z,{children:"Place:"}),t(W,{children:s.notice.place})]}),r(T,{children:[t(z,{children:"The sex:"}),t(W,{children:s.notice.sex})]}),r(T,{children:[t(z,{children:"Owner:"}),t(W,{children:s.user.name})]}),r(T,{children:[t(z,{children:"Email:"}),t(ye,{href:"mailto:"+s.user.email,children:s.user.email})]}),r(T,{children:[t(z,{children:"Phone:"}),t(ye,{href:"tel:"+s.user.mobile,children:s.user.mobile})]}),s.notice.category==="sell"&&r(T,{children:[t(z,{children:"Price:"}),t(W,{children:`${s.notice.price} ₴`})]})]})]})]}),r(At,{children:["Comments",r(Pt,{children:[": ",s.notice.comments]})]}),r(Et,{children:[r(Dt,{onClick:()=>{a?y():j(I)},children:[f?"del from":"add to",t(Wt,{src:f?Ee:Pe,alt:f?"heartFull":"heart"})]}),t(q,{}),t(jt,{href:"tel:"+s.user.mobile,children:"contact"})]}),t("link",{})]})})})},_t=o.div`
  position: relative;
  width: 450px;
  height: auto;
  background: #ffffff;
...
`;function Fi(){const[e,i]=c.useState(""),[n,a]=c.useState(null),l=H();return w(Ae),document.getElementById("input"),r(L,{children:[t($i,{children:"Find your favorite pet"}),t(Li,{children:r(Mi,{onChange:d=>{d.preventDefault(),l(le(e))},onFocus:d=>{a(!0)},onBlur:d=>{d.currentTarget===d.target&&(a(!1),e===""&&l(le("")))},children:[t(Ii,{id:"input",type:"text",onChange:d=>{i(d.target.value)},value:e,placeholder:"Search"}),n?t($e,{onClick:d=>{i(""),a(!1),l(le(""))},children:t(ki,{})}):t($e,{type:"submit",children:t(Si,{})})]})})]})}const Ei=()=>(it(),t(L,{children:r(Ci,{children:[t(Fi,{}),t(vi,{}),r(Yt,{children:[t(Ut,{}),t(ot,{})]})]})}));export{Ei as default};
