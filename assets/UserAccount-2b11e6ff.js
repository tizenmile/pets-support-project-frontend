import{s as u,e as G,r as m,j as a,a as f,h as Lt,i as Wt,d as U,A as gt,F as ie,Q as bt,k as Ut,p as h,l as Ht,m as qt,n as Kt,o as Nt,q as Vt}from"./index-e87eab96.js";import{c as xt,a as B,b as vt,F as Zt,d as Gt,E as Yt,u as Jt}from"./index.esm-e0e1d55e.js";import{G as ve}from"./iconBase-04fd4aa8.js";import{H as Qt,M as Xt,a as en,b as tn}from"./ModalBackdrop-ba2fd2dc.js";const nn=u.div`
  margin: 0 auto;
  padding-left: 20px;
  padding-right: 20px;
  padding-top: 61px;
...
`;const An=()=>{const e=G();m.useEffect(()=>{e(Wt())},[e]);const t=U(fn),{name:n,email:r,mobile:o,birthday:i,city:l,avatarURL:c}=t,[g,d]=m.useState(),[x,b]=m.useState(""),[D,y]=m.useState(!1),z=U(hn);return m.useEffect(()=>{b(c)}),a(gn,{children:z?a(gt,{}):f(ie,{children:[f(bn,{children:[g?a(Xe,{id:"img_container",src:g,alt:"avatar"}):a(Xe,{id:"img_container",src:x,alt:"avatar"}),f(xn,{children:[a(vn,{children:a("form",{children:a("input",{name:"userAvatar",type:"file",id:"userAvatar",accept:"image/jpg, image/png, image/jpeg, image/bmp",onChange:O=>{const _=new FileReader;if(O.target.files[0].size>5242880){bt.error("Image size bigger than 5MB");return}O.target.files[0]&&(_.readAsDataURL(O.target.files[0]),_.onloadend=()=>{const I=_.result;if(I.includes("image/png")||I.includes("image/jpg")||I.includes("image/jpeg")){d(I);const T=new FormData;T.append("image",O.target.files[0]),e(Ut(T))}})}})})}),f(wn,{htmlFor:"userAvatar",children:[a(yn,{}),"Edit photo"]})]})]}),a($n,{children:a(Z,{children:a(V,{children:f(Dn,{children:[f(Z,{children:[a(ne,{children:"Name:"}),a(V,{children:a(te,{isBtnDisabled:D,setIsBtnDisabled:y,defaultValue:n,name:"name",type:"text"})})]}),f(Z,{children:[a(ne,{children:"Email:"}),a(V,{children:a(te,{isBtnDisabled:D,setIsBtnDisabled:y,defaultValue:r,name:"email",type:"email"})})]}),f(Z,{children:[a(ne,{children:"Birthday:"}),a(V,{children:a(te,{isBtnDisabled:D,setIsBtnDisabled:y,defaultValue:i,name:"birthday",type:"date"})})]}),f(Z,{children:[a(ne,{children:"Phone:"}),a(V,{children:a(te,{isBtnDisabled:D,setIsBtnDisabled:y,defaultValue:o,name:"mobile",type:"tel"})})]}),f(Z,{children:[a(ne,{children:"City:"}),a(V,{children:a(te,{isBtnDisabled:D,setIsBtnDisabled:y,defaultValue:l,name:"city",type:"text"})})]})]})})})})]})})},En=()=>f(ie,{children:[a(on,{children:a(an,{children:"My information:"})}),a(An,{})]});function kn(e){return ve({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M9.207 8.5l6.646 6.646-0.707 0.707-6.646-6.646-6.646 6.646-0.707-0.707 6.646-6.646-6.647-6.646 0.707-0.707 6.647 6.646 6.646-6.646 0.707 0.707-6.646 6.646z"}}]})(e)}function yt(e){return ve({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M16 9h-7v7h-1v-7h-7v-1h7v-7h1v7h7v1z"}}]})(e)}const zn=u.button`
  display: flex;
  cursor: pointer;
  width: 40px;
  height: 40px;
...
`,Ir=({onClose:e})=>{m.useEffect(()=>{const w=S=>{S.code==="Escape"&&e()};return window.addEventListener("keydown",w),()=>{window.removeEventListener("keydown",w)}},[e]);const t=w=>{w.currentTarget===w.target&&e()},n=G(),[r,o]=m.useState(1),[i,l]=m.useState(""),{isAdding:c}=U(Sr),g=w=>{o(r+w)},{handleSubmit:d,handleBlur:x,values:b,handleChange:D,errors:y,touched:z}=Jt({initialValues:{name:"",date:"",breed:"",image:"",comments:""},validationSchema:Fn,onSubmit:w=>{const S=new FormData;for(let R in w)w[R].length>0&&S.append(R,w[R]);i&&S.set("image",i),n(qt(S)),e()}}),[A,O]=m.useState([]),{getRootProps:_,getInputProps:I,isDragActive:T}=Pt({maxFiles:1,accept:{"image/*":[".png",".jpg"]},onDrop:w=>{O(w.map(S=>Object.assign(S,{preview:URL.createObjectURL(S)}))),l(w[0])}});return a(Xt,{children:a(jr,{onClick:t,children:a(Or,{secondPage:r===2,children:f("form",{onSubmit:d,children:[a(Cr,{type:"button",onClick:e,children:a(kn,{})}),a("h3",{children:"Add pet"}),f(pt,{isHidden:r===2,isEmpty:b.date==="",children:[f("label",{children:["Name pet",a("input",{type:"text",name:"name",value:b.name,placeholder:"Type name pet",onChange:D,onBlur:x}),y.name||z.name?a("p",{children:y.name}):null]}),f("label",{children:["Date of birth",a("input",{type:"date",name:"date",value:b.date,min:"2000-01-01",max:wt,placeholder:"Type date of birth",onChange:D,onBlur:x}),y.date||z.date?a("p",{children:b.date?y.date:"Date must be a valid"}):null]}),f("label",{children:["Breed",a("input",{type:"text",name:"breed",value:b.breed,placeholder:"Type breed",onChange:D,onBlur:x}),y.breed||z.breed?a("p",{children:y.breed}):null]}),f(mt,{children:[a(ft,{type:"button",onClick:e,children:"Cancel"}),a(Re,{type:"button",onClick:()=>{const{name:w,date:S,breed:R}=b;if(!w||!S||!R){bt.info("Please fill in required fields");return}g(1)},children:"Next"})]})]}),f(pt,{isHidden:r===1,children:[a("h4",{children:"Add photo and some comments"}),f(Fr,{..._(),children:[a("input",{...I(),name:"image",value:b.image}),a(Pr,{children:T?null:f(ie,{children:[a(yt,{}),a("span",{children:"Click or Drop file"})]})}),a("div",{children:A.map(w=>a("div",{children:a("img",{src:w.preview,alt:"pet-avatar"})},w))})]}),f("label",{children:["Comments",a("textarea",{name:"comments",value:b.comments,placeholder:"Type comments",onChange:D,onBlur:x}),y.comments||z.comments?a("p",{children:y.comments}):null]}),f(mt,{children:[a(ft,{type:"button",onClick:()=>{g(-1)},children:"Back"}),a(Re,{type:"submit",disabled:c,children:"Done"})]})]})]})})})})},_r=e=>{const t=new Date(e),n=t.getDate().toString().padStart(2,"0"),r=(t.getMonth()+1).toString().padStart(2,"0"),o=t.getFullYear();return`${n}.${r}.${o}`},Tr=u.div`
  &:not(:last-child) {
    margin-bottom: 20px;
    @media ${e=>e.theme.media.desktop} {
      margin-bottom: 22px;
...
`,jt=({id:e,name:t,date:n,breed:r,comment:o,petAvatar:i})=>{const{isDeleting:l}=U(zr),c=G(),g=d=>{c(Kt(d)).unwrap()};return f(Tr,{children:[a(Rr,{src:i,alt:`${t}`}),f(Br,{children:[a(Mr,{type:"button",disabled:l,onClick:()=>g(e),children:a(Lr,{})}),f(fe,{children:[a(he,{children:"Name: "}),t]}),f(fe,{children:[a(he,{children:"Date of birth: "}),_r(n)]}),f(fe,{children:[a(he,{children:"Breed: "}),r]}),f(fe,{children:[a(he,{children:"Comments: "}),o]})]})]})};jt.prototype={id:h.string.isRequired,name:h.string.isRequired,date:h.string.isRequired,breed:h.string.isRequired,comments:h.string.isRequired,petAvatar:h.string.isRequired,removePet:h.func};const ht=u.div`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Wr=()=>{const e=U(Ar),t=U(Er),n=U(kr),r=G();return m.useEffect(()=>{r(Nt())},[r]),a(ie,{children:t?a(ht,{children:a(gt,{})}):n||e.length===0?a(ht,{children:"Please add your pet"}):!n&&!t&&(e==null?void 0:e.map(({_id:o,name:i,date:l,breed:c,comments:g,petAvatar:d})=>a(jt,{id:o,name:i,date:l,breed:c,comment:g,petAvatar:d},o)))})},Ur=u.section`
  width: 100%;
  @media ${e=>e.theme.media.tablet} {
...
`,Vr=()=>{const[e,t]=m.useState(!0),n=()=>{t(r=>!r)};return f(Ur,{children:[f(Hr,{children:[a(qr,{children:"My pets:"}),f(Kr,{children:[a(Nr,{children:"Add pet"}),a(On,{onClick:n})]})]}),!e&&a(Ir,{onClose:n}),a(Wr,{})]})},Zr=u.button`
  position: absolute;
  width: 89px;
  right: 12px;
  bottom: 20px;
...
`,Gr=u(tn)`
  ...
  margin-right: ${e=>e.theme.space[3]}px;
  color: ${e=>e.theme.colors.accent};
`,Yr=()=>{const e=G();return f(Zr,{type:"button",onClick:()=>e(Vt()),children:[a(Gr,{}),"Log Out"]})},ti=()=>f(nn,{children:[f(rn,{children:[a(En,{}),a(Yr,{})]}),a(Vr,{})]});export{ti as default};
