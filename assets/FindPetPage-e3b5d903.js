...
`,_t=({onClose:e,deleteNotice:i})=>(c.useEffect(()=>{const a=l=>{l.code==="Escape"&&e()};return window.addEventListener("keydown",a),()=>{window.removeEventListener("keydown",a)}},[e]),t(he,{children:t(me,{onClick:a=>{a.currentTarget===a.target&&e()},children:n(jt,{children:[t("h3",{style:{textAlign:"center"},children:"Are you sure?"}),n(Ot,{children:[t(we,{onClick:e,children:"Cancel"}),t(we,{onClick:i,children:"Delete notice"})]})]})})})),ye=({item:e})=>{const i=y(Fe),r=y(le),a=y(Z),l=y(ot),[g,s]=c.useState(!1),[p,m]=c.useState(!1),[f,h]=c.useState(!1),d=H(),k=()=>{s(!0)},L=()=>{m($=>!$)},u=$=>{s(!1),h($),a==="fav-notice"&&!$&&d(ge(e._id))},C=i.reduce(($,ee)=>($.push(ee._id),$),[]);c.useEffect(()=>{h(C.includes(e._id))},[i]);const v=()=>{h($=>!$),d(f?$e(e._id):Se(e._id)),a==="fav-notice"&&d(ge(e._id))},I=()=>{d(Ve(e._id)),d(Xe(e._id)),L()},A=()=>t("div",{children:t(Ie,{to:"/login",children:"You need to log in"})}),z=parseInt(new Date().getFullYear())-parseInt(new Date(e.birthDate).getFullYear()),b=["One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen"];let N;z<1?N="Less than a year":z>15?N="very old pet":z>=1&&z<=15?N=b[z-1]:N="unknown";const D=e.category;return n(xt,{children:[n(gt,{children:[n("div",{style:{flexGrow:1},children:[n(bt,{children:[t(ut,{src:e.photo,alt:e.title}),n(wt,{children:[D==="sell"&&"sell",D==="for-free"&&"in good hands",D==="lost-found"&&"lost/found"]}),t(yt,{onClick:()=>{r?v():_(A)},children:f?t("img",{src:Ee,alt:"heartFull"}):t("img",{src:Ae,alt:"heart"})})]}),t(vt,{style:{width:"280px"},children:e.title}),n(Nt,{children:[e.breed&&n(ie,{children:[t(W,{style:{width:"50px"},children:"Breed:"}),t(W,{style:{marginLeft:"40px"},children:e.breed})]}),n(ie,{children:[t(W,{style:{width:"50px"},children:"Place:"}),t(W,{style:{marginLeft:"40px"},children:e.place})]}),e.birthDate&&n(ie,{children:[t(W,{style:{width:"50px"},children:"Age:"}),t(W,{style:{marginLeft:"40px"},children:N})]})]})]}),t(ue,{style:e.userId!==l._id?{marginBottom:"32px"}:{marginBottom:"12px"},onClick:k,children:"Learn more"}),e.userId==l._id&&r&&n(ue,{onClick:L,children:["Delete",t(nt,{width:"16px",height:"17px"})]})]}),g&&t(Wt,{itemId:e._id,isFavorite:f,onClose:u}),p&&t(_t,{onClose:L,deleteNotice:I})]})},Ht=o.ul`
  max-width: 1248px;
  margin-left: auto;
  margin-right: auto;
  background-color: #fdf7f2;
...
`,bi=()=>{const[e,i]=c.useState(!1);return n(mi,{children:[n(at,{children:[t(xi,{children:"Add pet"}),t(fi,{onClick:()=>{i(!0)},children:n("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[t(ui,{}),t(gi,{children:"Add pet"})]})})]}),e&&t(hi,{onClose:()=>{i(!1)}})]})};function wi(){const e=y(le),i=Ze(),r=H(),a=y(Z);c.useEffect(()=>{r(G("sell")),r(re({page:0,categoryName:"sell"})),r(J(0)),i("/FindPet/sell",{replace:!0})},[r]);const l=p=>{r(G(p)),r(re({page:0,categoryName:p})),r(J(0)),i(`/FindPet/${p}`,{replace:!0})},g=p=>{r(G(p)),r(ze(0)),r(J(0)),i(`/FindPet/${p}`,{replace:!0})},s=p=>{r(G(p)),r(de(0)),r(J(0)),i(`/FindPet/${p}`,{replace:!0})};return t(Yt,{children:n(Jt,{children:[t(Ut,{children:n(Gt,{children:[t(Y,{children:t(U,{selected:a===S.lostFound,onClick:()=>l(S.lostFound),children:"lost/found"})}),t(Y,{children:t(U,{selected:a===S.free,onClick:()=>l(S.free),children:"in good hands"})}),t(Y,{children:t(U,{selected:a===S.sell,onClick:()=>l(S.sell),children:"sell"})}),e&&n(B,{children:[t(Y,{children:t(U,{selected:a===S.favorite,onClick:()=>s(S.favorite),children:"favorite ads"})}),t(Y,{children:t(U,{selected:a===S.my,onClick:()=>g(S.my),children:"my ads"})})]})]})}),e&&t(bi,{})]})})}function yi(e){return lt({tag:"svg",attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"circle",attr:{cx:"12",cy:"12",r:"10"}},{tag:"line",attr:{x1:"15",y1:"9",x2:"9",y2:"15"}},{tag:"line",attr:{x1:"9",y1:"9",x2:"15",y2:"15"}}]})(e)}o.section`
  margin-right: auto;
  margin-left: auto;
`;const vi=o(yi)`
  position: absolute;
