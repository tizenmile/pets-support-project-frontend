...
`,K=e=>Y.info(e,{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"}),Pe=j().shape({email:P().max(63,"Must be between 6 and 63 characters.").min(6,"Must be between 6 and 63 characters.").email("Invalid email address").matches(/[a-zA-Z]([-.\s]?[0-9a-zA-Z_-]){1,}@/,"The @ symbol must be preceded by at least 2 characters").required("Email is required").test("is-valid",e=>`${e.path} is invalid`,e=>e?ve(e):new fe("Invalid value")),password:P().min(7,"Must be between 7 and 32 characters.").max(32,"Must be between 7 and 32 characters.").matches(/^([-.\s]?[a-zA-Zа-яёА-ЯЁ0-9]*)*$/,"Must include numbers and/or letters (uppercase and lowercase) except for whitespace.").matches(/^\S*$/,"Password must not contain spaces").required("Password is required")}),Se=j().shape({name:P().required("Name is required"),city:P().required("City, region are required"),mobile:P().length(13,"For example +380##########. Must be 13 characters.").matches("^[+](380)[0-9]{9}$","For example +380##########. Must be 13 characters.").required("Mobile phone is required")}),ke={email:"",password:"",name:"",city:"",mobile:""},E=({name:e})=>n(pe,{name:e,render:a=>n($e,{children:a})}),Le=()=>{const[e,a]=R.useState(ke),[d,u]=R.useState(0),[i,o]=R.useState(!1),[r,t]=R.useState(!1),s=()=>{o(!i)},m=()=>{t(!r)},c=se(),p=_=>{const{email:w,password:b,name:f,city:l,mobile:$}=_;c(ce({email:w,password:b,name:f,city:l,mobile:$}))},q=(_,w=!1)=>{if(a(b=>({...b,..._})),w){p(_);return}u(b=>b+1)};return x(le,{children:[[n(Ee,{next:q,data:e,showPassword:i,togglePassword:()=>s(),showConfirmPassword:r,toggleConfirmPassword:()=>m()}),n(Ce,{next:q,prev:_=>{a(w=>({...w,..._})),u(w=>w-1)},data:e})][d],n(de,{position:"bottom-right",autoClose:5e3,hideProgressBar:!1,newestOnTop:!1,closeOnClick:!0,rtl:!1,pauseOnFocusLoss:!0,draggable:!0,pauseOnHover:!0,theme:"colored"})]})},Ee=e=>{const{showPassword:a,togglePassword:d,showConfirmPassword:u,toggleConfirmPassword:i}=e,o=r=>{if(r.email.toLowerCase().includes(".ru")){Y.error("Москалей не регистрируем",{position:"top-right",autoClose:5e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored"});return}if(!r.confirmPassword){K("Confirm password is required");return}r.confirmPassword===r.password&&e.next(r),r.confirmPassword!==r.password&&K("Passwords must match")};return n(ee,{initialValues:e.data,validationSchema:Pe,onSubmit:o,children:({values:r})=>x(te,{children:[x(k,{children:[n(S,{placeholder:"Email",type:"email",name:"email",value:r.email||""}),n(E,{name:"email"})]}),x(k,{children:[x(G,{children:[n(S,{placeholder:"Password",name:"password",value:r.password||"",type:a?"text":"password"}),n(J,{onClick:d,children:n(X.Provider,{value:{color:"rgba(245, 146, 86, 1)",size:35},children:a?n(Q,{}):n(Z,{})})})]}),n(E,{name:"password"})]}),x(k,{children:[x(G,{children:[n(S,{placeholder:"Confirm Password",type:u?"text":"password",name:"confirmPassword",validate:P()}),n(J,{onClick:i,children:n(X.Provider,{value:{color:"rgba(245, 146, 86, 1)",size:35},children:u?n(Q,{}):n(Z,{})})})]}),n(E,{name:"confirmPassword"})]}),n(re,{type:"submit",children:"Next"})]})})},Ce=e=>{const a=(d,u)=>{e.next(d,!0)};return n(ee,{initialValues:e.data,validationSchema:Se,onSubmit:a,children:({values:d})=>x(te,{children:[x(k,{children:[n(S,{placeholder:"Name",type:"text",name:"name",value:d.name||""}),n(E,{name:"name"})]}),x(k,{children:[n(S,{placeholder:"City, region",type:"text",name:"city",value:d.city||""}),n(E,{name:"city"})]}),x(k,{children:[n(S,{placeholder:"Mobile phone",type:"text",name:"mobile",value:d.mobile||""}),n(E,{name:"mobile"})]}),n(re,{type:"submit",children:"Register"}),n(Fe,{type:"button",onClick:()=>e.prev(d),children:"Back"})]})})};export{Le as A,E as F,G as P,Me as R,Ae as a,Oe as b,Ie as c,Be as d,J as e,ve as i,ye as l};
