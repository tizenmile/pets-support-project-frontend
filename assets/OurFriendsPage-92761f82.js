import{s as h,j as m,F as Z,a as y,r as ee,d as de,e as le,T as me}from"./index-79f56e00.js";const ce=h.h1`
  font-family: "Manrope";
  font-style: normal;
  font-weight: 700;
  font-size: 48px;
...
`,Yt=h.li`
  margin-bottom: 4px;
`,Et=({workDays:e})=>{const a=new Date,t=["MN","TU","WE","TH","FR","SA","SU"],n=["SU","MN","TU","WE","TH","FR","SA"];return m("div",{children:e&&m($t,{children:y(Yt,{children:[t.map(r=>m(Wt,{style:{color:n[a.getDay()]===r&&"#f59256"},children:r},r)),m(Ut,{children:e&&e.map((r,i)=>y(_t,{style:{color:kt(new Date,"i")-1===i&&"#f59256"},children:[r&&r.isOpen?r.from:"",r&&r.isOpen&&"-",r&&r.isOpen?r.to:"Closed"]},r._id))})]})})})},Ft=h.div``,Nt=h.ul`
  position: reletive;
`,Lt=h.img`
  width: 158px;
  height: 112px;

  @media ${e=>e.theme.media.mobileMin} and ${e=>e.theme.media.mobileMax} {
    width: 110px;
    height: 78px;
  }
...
font-size: ${e=>e.theme.fontSizes.xs};
line-height: 19px;
`,Rt=({data:e})=>{const{title:a,url:t,addressUrl:n,imageUrl:r,address:i,workDays:o,phone:s,email:d}=e,[l,f]=ee.useState(!1);return y(Ft,{children:[m(qt,{children:m(zt,{href:t,target:"_blank",children:a})}),y(Ht,{children:[m("a",{href:t,target:"_blank",children:m(Lt,{src:r??"https://animals-city.org/wp-content/themes/animals-city/img/logo.svg",alt:a})}),y(Nt,{children:[m(F,{children:y(N,{onMouseOver:()=>{f(!0)},onMouseOut:()=>{f(!1)},children:["Time: ",m("br",{}),o&&(o[0].from||o[6].from)?o[0].from||o[6].from:"--------","-",o&&(o[0].to||o[6].to)?o[0].to||o[6].to:"--------",l&&m(Et,{workDays:o})]})}),m(F,{children:y(N,{href:i&&n,target:"_blank",children:["Address: ",m("br",{})," ",i||"-----------------"]})}),m(F,{children:y(N,{href:d&&`mailto:${d}`,children:["Email: ",m("br",{}),d||"-----------------"]})}),m(F,{children:y(N,{href:s&&`tel:${s}`,children:["Phone: ",m("br",{}),s||"-----------------"," "]})})]})]})]})},It=h.ul`
  max-width: 1280px;
  margin-left: auto;
  margin-right: auto;
  margin-top: -16px;
...
`,Xt=e=>{var a,t;return(t=(a=e==null?void 0:e.friends)==null?void 0:a.friendsList[0])==null?void 0:t.sponsors},At=()=>{const e=de(Xt),a=le();if(ee.useEffect(()=>{a(me())},[]),!!e)return console.log(e),m(Qt,{children:m(It,{children:e.map(t=>m(Bt,{children:m(Rt,{data:t})},t._id))})})},jt=()=>y(Z,{children:[m(fe,{title:"Our friends"}),m(At,{})]});export{jt as default};
